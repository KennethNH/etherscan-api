...
/**
 * @param {string} network - Network to connect to [eth, bsc]
 ...
 */
module.exports = function(network, apiKey, chain, timeout) {
  ...
  var getRequest = require('./get-request')(network, chain, timeout);
